...
window.container;
window.camera, window.scene, window.renderer, window.particles, window.geometry, window.materials = [], window.parameters, window.i, window.h, window.color, window.size;
